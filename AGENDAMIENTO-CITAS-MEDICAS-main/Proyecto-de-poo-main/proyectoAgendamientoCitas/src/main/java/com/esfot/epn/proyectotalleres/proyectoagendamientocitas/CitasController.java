...
public class CitasController implements Initializable {
    ...
    /** Validacion (que no cruze la hora o el paciente tenga otra cita a la misma hora
     */
    ...
    /**
     * hora tenga formato HH:mm (24h) y la normaliza (ej. "9:5" -> "09:05") y null si el formato no es válido.
     */
